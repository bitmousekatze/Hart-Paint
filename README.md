...
- **Save / Load Project** (`.hartproject` format — preserves all layers, settings, and history)
- Open any image file to start painting
...
| `Enter`              | Commit floating selection or finish polyline |
| `Esc`                | Cancel selection / polyline / lasso |
...
1. Download the latest `hart-paint.html` from the [Releases](../../releases) page (or just the raw file from the repo).
2. Double-click the file — it opens instantly in your browser.
3. Start painting!
4. **Pro tip:** Press `?` or check the top bar for quick actions.
...
[MIT License](LICENSE) — feel free to use, modify, and distribute this project however you like.
